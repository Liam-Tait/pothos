...
import { InputFieldsFromShape, InputRef, inputShapeKey, PothosInputObjectTypeConfig, RecursivelyNormalizeNullableFields, SchemaTypes, } from '../types/index.ts';
import BaseTypeRef from './base.ts';
export default class InputObjectRef<Types extends SchemaTypes, T> extends BaseTypeRef<Types, PothosInputObjectTypeConfig> implements InputRef<T>, PothosSchemaTypes.InputObjectRef<Types, T> {
    override kind = "InputObject" as const;
    [inputShapeKey]!: T;
    constructor(builder: PothosSchemaTypes.SchemaBuilder<Types>, name: string, config?: PothosInputObjectTypeConfig) {
