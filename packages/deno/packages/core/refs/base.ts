...
export default class BaseTypeRef<Types extends SchemaTypes, T = unknown> implements PothosSchemaTypes.BaseTypeRef<Types, T> {
    ...
    constructor(builder: PothosSchemaTypes.SchemaBuilder<Types>, kind: "Enum" | "InputObject" | "Interface" | "Object" | "Scalar" | "Union" | "List" | "InputList", name: string, config: T | null = null) {
    ...
    private allRefs = (refs = new Set<BaseTypeRef<Types, T>>()): RefCollection<BaseTypeRef<Types, T>, T> => {
