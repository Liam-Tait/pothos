...
import { InterfaceParam, ObjectTypeOptions, OutputRef, outputShapeKey, parentShapeKey, PothosObjectTypeConfig, SchemaTypes, } from '../types/index.ts';
import BaseTypeRef from './base.ts';
export default class ObjectRef<Types extends SchemaTypes, T, P = T> extends BaseTypeRef<Types, PothosObjectTypeConfig> implements OutputRef, PothosSchemaTypes.ObjectRef<Types, T, P> {
