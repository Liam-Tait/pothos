...
export default class InterfaceRef<Types extends SchemaTypes, T, P = T> extends BaseTypeRef<Types, PothosInterfaceTypeConfig> implements OutputRef, PothosSchemaTypes.InterfaceRef<Types, T, P> {
